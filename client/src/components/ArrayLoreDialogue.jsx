...
const EldenTexts = [
    ...
    {
        id: 2,
        content: "Bonjour âme déchue, la vie heureuse que tu as connue n’est plus. Si tu souhaites la retrouver tu devras accomplir plusieurs choses pour moi"
    }, // Le deuxième ID est la voix, si possible mettre un CSS en italique pour la compréhension du joueur
    {
        id: 3,
        content: "La provenance de cette voix douteuse est inconnue pour vous, vous décidez donc de l’écouter, c’est le seul moyen de récupérer votre ancienne vie. Vous vous levez pour explorer ce monde sans vraiment savoir ce qui vous attend."
    }, // Le troisième ID représente le début (officiel) de l'aventure
    {
        id: 4,
        content: "Vous avancez sur un grand pont en pierre qui mène à l’entrée d’un château. À l’entrée de ce château se trouvent 2 coffres, l’un d’eux est grand, vieux et brisé, l'autre est plus petit mais vous avez la sensation que ce coffre renferme quelque chose de puissant."
    ...
    {
        id: 6,
        content: "Vieux coffre : Vous trouvez un immense katana, la voix vous dit que c’est le Nagakiba, une lame puissante qui vous sera d’une grande utilité."
    }, 
    {
        id: 65,
        content: "Petit coffre : Vous trouvez une épée droite usée, la voix vous dit que cette épée n’est pas très puissante mais que c’est toujours mieux que rien."
    ...
    {
        id: 9,
        content: "Combat terminé : vous voyez deux objets tomber au sol. À gauche - vous voyez une sorte de méduse peu ragoûtante au sol. À droite - vous apercevez ce qui pourrait s’apparenter à un bouclier."
    ...
    {
        id: 12,
        content: "C'était une Mimic que vous avez battu."
    ...
    {
        id: 14,
        content: "Au fond de cette salle, vous vous trouvez face à une grande porte, vous l’ouvrez avec difficulté et découvrez la sortie du château. Une brume épaisse trouble votre vue mais vous distinguez un chemin. Effrayé et surpris, vous trouvez sur votre route un cadavre transpercé d’une dague."
    ...
    },
    {
        ...
        id: 18,
        content: "Bonne initiative, cette dague est très rapide et très puissante."
